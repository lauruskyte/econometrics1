 ...
 * Funkcijos išvestyje pateikta:
   1) Duomenys ("data") - musu nagrinejama imtis
   2) Statistika ("t")
   3) Stjudento skirstinio laisvės laipsnis ("df")
   4) Tikimybė, kad bus atmesta tesinga nulinė hipotezė ("p-value")
   5) Alternatyva: vidurkis nelygus vienetui ("alternative hypothesis: true mean is not equal to 1")
   6) 95% pasikliautinasis intervalas bei jo apatinė ir virsutinė ribos ("95 percent confidence interval")
   7) Imties iverčiai: imties vidurkis ("sample estimates:
mean of x")

 * Jei norime atmesti arba priimti nulinę hipotezę, turime atsižvelgti į:
   1) "p-value" - jei ji mažesnė už reikšmingumo lygmenį α, tada nulinė hipotezė atmetama, jei didesnė - priemame
   2) "95% confidence interval" - jei vienetas pakliūna į šį intervalą, tada nulinę hipotezę priemame, jei nepakliūna - atmetame
 ...
 * IŠVADOS:
Remdamiesi gautais duomenimis galime daryti išvadą, jog yra 4.8% tikimybė atmesti nulinę hipotezę imčiai su vidurkiu lygiu vienetui. Taigi, vidurkis statistiškai reikšmingai nesiskiria nuo vieneto.
